    ...
    return (
        <div className="text-center custom-50vh pt-3 subscribe-div">
            ...
            <div className="input-group d-flex justify-content-center">
                <input className="type-mail bg-white px-5 py-2 mt-4 shadow-effect" placeholder="Type your email here..." />
                <div className="input-group-append">
                    <button className="btn send-mail-btn rounded-circle text-white mt-4" type="button">&#x27a4;</button>
                </div>
            </div>
        </div>
    )
